		...
		<div class="center">
			...
			<div>
				...
				<p>
					...
					open-ended questions and closed-ended questions, can make it, so you eliminate some
					potential bias. Make sure the question clear and concise as to eliminate any room for bias
					and create a simple question that won't confuse any respondents.
				</p>
			</div>
		</div>
	</div>
